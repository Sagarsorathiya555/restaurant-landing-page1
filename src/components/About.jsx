...
import AboutBackgroundImage from "../assets/i17.png";
    ...
    <div className='about-section-container'>
        ...
        <div className='about-section-text-container'>
          ...
          elit. Dolor turpis molestie dui magnis facilisis at fringilla quam.</p>
            <p className='primary-text'>Non tincidunt magna non et elit. Dolor turpis molestie dui magnis
          facilisis at fringilla quam.</p>
